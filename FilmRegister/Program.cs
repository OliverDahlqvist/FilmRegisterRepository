...
namespace FilmRegister
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            menus[0].AddMenuItem("Title", spacingTitle, defaultColor, defaultColor, showCursor: false);
            menus[0].AddMenuItem("Genre", spacingOther, defaultColor, defaultColor, showCursor: false);
            menus[0].AddMenuItem("Rating", spacingOther, defaultColor, defaultColor, showCursor: false);
            menus[0].AddMenuItem("Length", spacingOther, defaultColor, defaultColor, showCursor: false);
            menus[0].AddMenuItem("Seen", spacingOther, defaultColor, defaultColor, showCursor: false);
